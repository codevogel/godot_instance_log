...
1. Copy the `addons/instance_log` folder into your Godot project. (Download [from the
   repository](https://github.com/codevogel/godot_instance_log) as a .zip, or download from
